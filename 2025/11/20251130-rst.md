...
ネットで検索すると非同期の時には気を付けることがあるというのが出てきたが、
[Spans](https://docs.rs/tracing/latest/tracing/#spans) のところしか async/await が出てこなかったので使わないうちは大丈夫なのかな？ 
暗黙で使われているとかだと困るのだが、まあまだいいや。
