...
理解するよりも、読み方が分からないということを知っておくのが目的だ。
...
というところに至るまで大変だったので省略だ。deepwiki への質問履歴を載せておく。  
...
### rust-lang.org と rust-jp.rs

`range` を検索していて、似たような内容なのだが URL が異なるサイトが見つかった。

* [for と range - Rust By Example](https://doc.rust-lang.org/stable/rust-by-example/ja/flow_control/for.html)
  * doc.rust-lang.org
  * [rust-lang/rust-by-example: Learn Rust with examples (Live code editor included)](https://github.com/rust-lang/rust-by-example)
* [for と range - Rust By Example 日本語版](https://doc.rust-jp.rs/rust-by-example-ja/flow_control/for.html)
  * doc.rust-jp.rs
  * [rust-lang-ja/rust-by-example-ja: rust-by-exampleの和訳リポジトリ](https://github.com/rust-lang-ja/rust-by-example-ja)
    * [Rust By Example本家へのマージ · Issue #184 · rust-lang-ja/rust-by-example-ja](https://github.com/rust-lang-ja/rust-by-example-ja/issues/184)

doc.rust-jp.rs を本家にマージしたようなので、少なくとも Rust By Example については「日本語版」が付かない方が新しい可能性が高そうだ。  
book-ja は今のところ [「日本語版」](https://doc.rust-jp.rs/book-ja/)だけになるのかな([github](https://github.com/rust-lang/book/blob/39aeceaa3aeab845bc4517e7a44e48727d3b9dbe/src/appendix-06-translation.md?plain=1#L16))。
