...
```log
2025-12-22T01:33:25.380404Z  INFO hello: main
2025-12-22T01:33:25.380486Z  INFO sub: hello: sub: 10
2025-12-22T01:33:25.380544Z  INFO sub:sub: hello: subsub: 10
2025-12-22T01:33:25.380591Z  INFO hello: main done: 10
```
...
```log
2025-12-22T01:34:16.700592Z  INFO hello: main
2025-12-22T01:34:16.700670Z  INFO その1: hello: sub: 10
2025-12-22T01:34:16.700726Z  INFO その1:その2: hello: subsub: 10
2025-12-22T01:34:16.700786Z  INFO hello: main done: 10
```

### 別モジュールには名前が付く

別のモジュールを呼び出した場合は span 名とは別にモジュールパスの付いた関数名が出力されるようだ。  
全部コロンで区切ってあるので読みづらいな。  
それだけだったら無理に span 名を付けなくてもよい気はするが、グループが分かるのはやっぱりよいかも。
...
```log
2025-12-22T01:32:26.164389Z  INFO hello: main
2025-12-22T01:32:26.164463Z  INFO sub: hello: sub: 10
2025-12-22T01:32:26.164517Z  INFO sub:sub: hello: Sub::sub: 10
2025-12-22T01:32:26.164562Z  INFO sub:sub:sub: hello::foo: foo::sub: 10
2025-12-22T01:32:26.164614Z  INFO hello: main done: 10
```
...
Thread ID なるものも出力。
タスクのIDではなく、今動いているスレッドのIDである。
`.await` でスケジューラに戻った後に再開すると別のスレッドになっていることもあるため、
どのタスクが出力したログなのかを見たいという用途としては使用できない。
