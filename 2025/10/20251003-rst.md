...
さて、前回までで [rust-bitcoin-sample](https://github.com/hirokuma/rust-bitcoin-sample) と [bdk-example](https://github.com/hirokuma/bdk-example) でそれぞれトランザクションを作るところまで行った。
