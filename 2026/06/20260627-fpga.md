...
今だと"ZYBO Z7"が売られているが、持っているのは9年ほど前に購入した無印のZYBOだ。
ボード自体は2013年のもののようだ。Rev B。
...
WinPcapのインストールも行われるのだが、WireSharkでWinPcapが使われなくなったのはなんでだったか調べたところ開発がもう終了しているからだった。
とりあえずインストールはしたのだが、Npcapで代用できるならそっちの方が良い気がする。

* [WinPcap - Wireshark Wiki](https://wiki.wireshark.org/WinPcap)
