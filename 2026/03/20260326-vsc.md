...
## GitHub Copilot Chatのせいなのか

おそらくだが、GitHub Copilot Chat extensionを有効にしている場合に起きる。  
かつ、それ以外のGitHub関係のextensionを無効にしている場合なのかな。

なので、使っていないならGitHub Copilot extensionをdisableにすると解消するだろう。

## 全部Hideにする

それ以外に、GitHub Copilot Chatのサイドバーのプロンプト欄？のコンボボックスにある "Configure Custom Agents.." で全部Hideにするだけでも出てこなくなった。

![image](images/20260326a-2.png)
