...
そういうことをしたいならコマンドラインから`flutter create <プロジェクト名>`でプロジェクトディレクトリを作ってからvscodeを起動するのがよいか。
私はAndroidとiOSででしか考えていなかったが、オプションなしで作るとMacOS, Linux, Web, Windowsのディレクトリも作られたので、
お客さんにコマンドラインアプリを試してもらうのは面倒だなあ、というときの選択肢になるかもしれない。

その後ここを見て知ったのだが、vscodeからアプリを作ると開き直してくれるそうだ。なんだー。

* [初めての Flutter アプリ](https://codelabs.developers.google.com/codelabs/flutter-codelab-first?hl=ja#2)
