...
* [github](https://github.com/hirokuma/rust-spawn-blocking)
...
作業しているプログラムに `spawn_blocking` を組み込もうとしたがダメだった。  
`tokio::sync::Mutex` で lock した変数を使おうとしたからか？

あまり考えずにAIへ修正をお任せしたところ `block_in_place` に置き換えられた。  
multi thread でしか使えないらしく flavor = "current_thread" は削除した。
...
```log
2026-02-07T14:03:35.017028Z  INFO spawn_blocking: task1 begin
2026-02-07T14:03:35.017037Z  INFO spawn_blocking: task2 begin
2026-02-07T14:03:36.019235Z  INFO spawn_blocking: task1 end
2026-02-07T14:03:36.019340Z  INFO spawn_blocking: task1 begin
2026-02-07T14:03:37.020192Z  INFO spawn_blocking: task1 end
2026-02-07T14:03:37.020247Z  INFO spawn_blocking: task1 begin
2026-02-07T14:03:38.022079Z  INFO spawn_blocking: task1 end
2026-02-07T14:03:38.022231Z  INFO spawn_blocking: task1 begin
2026-02-07T14:03:39.023923Z  INFO spawn_blocking: task1 end
2026-02-07T14:03:39.024030Z  INFO spawn_blocking: task1 begin
2026-02-07T14:03:40.017833Z  INFO spawn_blocking: task2 end
2026-02-07T14:03:40.017948Z  INFO spawn_blocking: task2 begin
2026-02-07T14:03:40.025585Z  INFO spawn_blocking: task1 end
2026-02-07T14:03:40.025706Z  INFO spawn_blocking: task1 begin
```

[block_in_place](https://docs.rs/tokio/latest/tokio/task/fn.block_in_place.html) はなかなか不思議なメソッドのようだ。

> Runs the provided blocking function on the current thread without blocking the executor.

`spawin_blocking` とは逆で、今のスレッドから自分を切り離すのではなく自分以外を切り離すということか？ 
なかなか大胆だが、自分を切り離すのと自分以外を切り離すのとの両方があるのは合理的だ。
