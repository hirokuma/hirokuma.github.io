...
悩む、悩むね。  
libssl で使っているのが SHA256, RIPEMD160、あとは乱数生成くらいなのだ。  
もうちょっと扱いやすいライブラリがあると思うのだ。  
...
Star の数では libtomcrypt がかなり多い。  
GnuPG なので多いのかと思ったが、GnuPG だからこそあまり汎用では使わないということかもしれない。
