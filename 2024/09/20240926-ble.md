...
bondhing 周りだと思うが、以前の私はよく理解できないままやっていた。
...
V4.0の頃から変わっていないようだ。  
この図の Phase 1-3 は DevAcademy の Phase 1-3 は一致している。
...
アドレスも、見た目では Public か Private かはわからないとかだったと思う。  
